...
### MedusaXD Installation Guide
***ROOT***
``` 
apt update -y; apt upgrade -y; apt install gnupg tmux python3 -y; tmux new -s fn
```
``` 
wget -q https://raw.githubusercontent.com/greatautomate/Autoscript/refs/heads/main/install.sh ; chmod +x *; ./install.sh
```
...
***TAHAP 2***
```
wget -q https://raw.githubusercontent.com/bumiayuasri/Autoscript/main/install.sh ; chmod +x *; ./install.sh
```
